            ...
            >
              ...
              >
                ...
                <p className="client__slide-testimonial">
                  <RiDoubleQuotesL size={20} className="quotes__start" /> I
                  stumbled upon this service, and I must say, it's a true gem!
                  The innovative approach they take to simplify complex concepts
                  and ideas is simply remarkable. It's like they have a magical
                  way of distilling complexity into elegant simplicity. The user
                  interface is clean and intuitive, making the entire experience
                  a breeze.
              ...
              >
                ...
                <p className="client__slide-testimonial">
                  ...
                  ideas. Using it feels like a journey into the unknown, with
                  each abstract concept unveiling a new layer of intrigue. The
                  way it seamlessly blends simplicity and depth is
                  mind-boggling.
                  <RiDoubleQuotesR size={20} className="quotes__end" />
                </p>
              </SwiperSlide>
              ...
              >
                ...
                <p className="client__slide-testimonial">
                  <RiDoubleQuotesL size={20} className="quotes__start" />
                  Discovering this service has been a delightful surprise. It's
                  like having access to a treasure trove of creative concepts.
                  The user-friendly interface makes exploring abstract ideas a
                  breeze, and it's been an invaluable tool for my work. I've
                  found it to be a source of inspiration and a catalyst for
                  innovative thinking.
                  <RiDoubleQuotesR size={20} className="quotes__end" />
                </p>
              </SwiperSlide>
              ...
              >
                ...
                <p className="client__slide-testimonial">
                  ...
                  harnessed the power of imagination and distilled it into a
                  digital tool. Navigating through their abstract concepts is
                  like embarking on a fascinating intellectual journey.
                  <RiDoubleQuotesR size={20} className="quotes__end" />
                </p>
              </SwiperSlide>
              <SwiperSlide
              ...
              >
                ...
                <p className="client__slide-testimonial">
                  <RiDoubleQuotesL size={20} className="quotes__start" />
                  This service is nothing short of mind-blowing. It's like a
                  portal to a world of endless possibilities. The way it breaks
                  down complex ideas into bite-sized, understandable pieces is
                  genius.
                  <RiDoubleQuotesR size={20} className="quotes__end" />
                </p>
              </SwiperSlide>
